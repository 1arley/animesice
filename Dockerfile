...
ENV NEXT_PUBLIC_SITE_URL=${NEXT_PUBLIC_SITE_URL:-https://www.animesice.app}
...
ARG NEXT_PUBLIC_MONETAG_DIRECT_LINK
ENV NEXT_PUBLIC_MONETAG_DIRECT_LINK=${NEXT_PUBLIC_MONETAG_DIRECT_LINK:-https://omg10.com/4/11645885}
ARG NEXT_PUBLIC_DISABLE_ADS
ENV NEXT_PUBLIC_DISABLE_ADS=${NEXT_PUBLIC_DISABLE_ADS:-0}
