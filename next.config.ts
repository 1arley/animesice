...
const cspHeader = `
  default-src 'self';
  script-src 'self' 'unsafe-inline' 'nonce-${'__NONCE_PLACEHOLDER__'}' https://al5sm.com https://static.cloudflareinsights.com https://challenges.cloudflare.com https://www.googletagmanager.com https://www.google-analytics.com;
