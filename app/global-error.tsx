...
export default function GlobalError({
  ...
  return (
    <html lang="pt-BR">
      <body style={{ background: "#080C12", color: "#F1F5F9", fontFamily: "system-ui, sans-serif" }}>
        <div
        ...
        >
          ...
          <div style={{ marginTop: "1.5rem", display: "flex", gap: "0.75rem" }}>
            <button
              onClick={handleRetry}
              style={{ padding: "0.6rem 1.5rem", background: "#38E8DA", color: "#080C12", border: "none", borderRadius: "3px", cursor: "pointer", fontWeight: 600 }}
            >
              Tentar novamente
            </button>
            <a
              href="/"
              style={{ padding: "0.6rem 1.5rem", background: "transparent", color: "#F1F5F9", border: "1px solid #1F2B3E", borderRadius: "3px", cursor: "pointer", textDecoration: "none" }}
            >
              Voltar à prateleira
            </a>
          </div>
