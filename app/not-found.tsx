...
export default function NotFound() {
  return (
    <div className="w-full h-screen items-center justify-center flex flex-col">
      <div className="w-full h-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-8 lg:gap-24 px-10 md:px-0">
        <div>
          <Image
            priority
            loading="eager"
        ...
        <div className="flex flex-col items-center justify-center gap-20 md:gap-28">
          ...
          <div className="flex flex-col md:flex-row gap-7 w-full items-center justify-center">
            <Link
              className="btn-ice w-60 h-10 inline-flex items-center justify-center whitespace-nowrap"
              href="/"
            >
              Voltar à prateleira
            </Link>
