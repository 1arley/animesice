...
const ICONS: Record<string, string> = {
  ...
  calendario:
    "M4 8h16M6 4v3M18 4v3M5 6h14a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1Z",
  aleatorio:
    "M7 4v3M7 17v3M4 7h3M4 17h3M17 4v3M17 17v3M14 7h3M14 17h3M9 10h.01M15 10h.01M9 14c1 1 5 1 6 0",
  filmes:
    "M3 5h18v14H3zM3 9h4v2H3zM3 12h4v2H3zM17 9h4v2h-4zM17 12h4v2h-4zM3 14h18M3 7h18",
  ...
  usuarios:
    "M9 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM2 20c1-3 3.5-4.5 7-4.5s6 1.5 7 4.5M16 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5ZM15 14c2.5.5 4.5 2.5 5 6",
  pedidos: "M4 6h12v12H4zM16 10h3l1 2v6h-4M7 10h6M7 14h4",
  sugestoes:
    "M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 16.8 5.8 21.3l2.4-7.4L2 9.4h7.6L12 2z",
  regras:
    "M4 6h16M4 12h16M4 18h10M5 3h6v4H5zM13 3h6v4h-6zM5 15h6v4H5zM13 15h2v4h-2z",
  config:
    "M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8ZM12 2v2M12 20v2M4 12H2M22 12h-2M5 5l1.5 1.5M17.5 17.5 19 19M19 5l-1.5 1.5M6.5 17.5 5 19",
  biblioteca:
    "M5 4h4v16H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1ZM11 4h4v16h-4zM17 4h1a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-1z",
...
export function SiteNav() {
  ...
  const closeMobile = useCallback((opts?: { force?: boolean }) => {
    ...
    if (!opts?.force && Date.now() - openingAt.current < GHOST_WINDOW_MS)
      return;
    setClosing(true);
