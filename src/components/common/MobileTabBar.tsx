        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              ...
              className={`flex min-h-14 flex-col items-center justify-center gap-0.5 py-1.5 font-mono text-caption uppercase tracking-wider transition-colors active:scale-95 ${
